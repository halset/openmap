...
public class RpfLayer
    ...
    protected static Logger logger = LoggerFactory.getLogger("com.bbn.openmap.layer.rpf.RpfLayer");
    protected static Logger rpfLogger = LoggerFactory.getLogger("RPF");
    ...
    public void setPaths(String[] pathsToRPFDirs) {
        ...
        if (pathsToRPFDirs != null) {
            ...
            logger.error("Need RPF directory paths.");
            frameProvider = null;
        }
    ...
    public void removed(java.awt.Container cont) {
        if (killCache) {
            rpfLogger.debug("emptying cache!");
            clearCache();
        }
    ...
    public synchronized OMGraphicList prepare() {
        ...
        if (this.cache == null) {
            rpfLogger.debug(getName() + ": Creating cache!");
        ...
        rpfLogger.debug(getName() + " doing it");
        ...
        // call getRectangle();
        if (rpfLogger.isDebugEnabled()) {
            rpfLogger.debug(getName() + "calling getRectangle " + " with projection: " + projection + " ul = "
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug(getName() + ": finished with " + retList.size() + " graphics");
            }

        } catch (java.lang.NullPointerException npe) {
            logger.error(getName() + ": Something really bad happened - \n " + npe);
            npe.printStackTrace();
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd == showMapsCommand) {
            ...
            // logger.error("RpfLayer: Unknown action command \"" + cmd
            // +
